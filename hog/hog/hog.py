...
def boar_brawl(player_score, opponent_score):
    ...
    digits = player_score%10
    return 3*abs(tens-digits) if 3*abs(tens-digits)>1 else 1
    # END PROBLEM 2
...
def final_strategy(score, opponent_score, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    score_add = int(averaged_dice(6))+score
    if score_add > sus_update(0,score,opponent_score):
        return score_add
    else:
        return sus_update(0,score,opponent_score)
